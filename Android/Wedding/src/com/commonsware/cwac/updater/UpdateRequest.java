...
public class UpdateRequest {
	...
	ConfirmationStrategy getPreDownloadConfirmationStrategy() {
		return ((ConfirmationStrategy) cmd
				.getParcelableExtra(EXTRA_CONFIRM_DOWNLOAD));
	}

	ConfirmationStrategy getPreInstallConfirmationStrategy() {
		return ((ConfirmationStrategy) cmd
				.getParcelableExtra(EXTRA_CONFIRM_INSTALL));
	}
	...
	public static class Builder {
		...
		public Builder setPreDownloadConfirmationStrategy(
		...
		public Builder setPreInstallConfirmationStrategy(
				ConfirmationStrategy strategy) {
		...
		PendingIntent buildPendingIntent() {
			...
			return (PendingIntent.getBroadcast(ctxt, 0, i,
